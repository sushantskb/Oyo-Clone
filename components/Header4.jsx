...
const Header4 = () => {
  return (
    <div className="flex justify-between items-center my-4 border-2 rounded-lg border-gray-300 px-5">
      ...
      <div className="flex">
          ...
          />
          <button className="w-48 rounded-lg h-14 bg-red-500 text-xl text-white cursor-pointer">
            Notify
          </button>
        </div>
    </div>
